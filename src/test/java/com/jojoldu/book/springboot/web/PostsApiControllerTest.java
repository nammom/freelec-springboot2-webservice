...
public class PostsApiControllerTest {
    ...
    @Autowired
    private TestRestTemplate restTemplate;  //JPA기능 테스트할때 사용
    ...
    public void Posts_수정된다() throws Exception{
        ...
        //restTemplate.exchange : postForEntity 메소드와 달리 HTTP method를 지정할 수 있음
        */
